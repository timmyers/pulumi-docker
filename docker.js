...
function buildAndPushImage(imageName, pathOrBuild, repositoryUrl, logResource, connectToRegistry) {
    return pulumi.all([pathOrBuild, repositoryUrl])
        .apply(([pathOrBuild, repositoryUrl]) => __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield buildAndPushImageWorkerAsync(imageName, pathOrBuild, repositoryUrl, logResource, connectToRegistry);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const login = () => {
            if (!loggedIn) {
                ...
                const registryPromise = registryOutput.promise();
        ...
        const { imageId, stages } = yield buildImageAsync(imageName, pathOrBuild, logResource, cacheFrom);
        ...
        if (!pulumi.runtime.isDryRun()) {
            ...
            yield tagAndPushImageAsync(imageName, repositoryUrl, tag, imageId, logResource);
            yield tagAndPushImageAsync(imageName, repositoryUrl, tag, /*imageId:*/ undefined, logResource);
            for (const stage of stages) {
                yield tagAndPushImageAsync(localStageImageName(imageName, stage), repositoryUrl, stage, /*imageId:*/ undefined, logResource);
            }
        }
...
function pullCacheAsync(imageName, cacheFrom, login, repoUrl, logResource) {
    return __awaiter(this, void 0, void 0, function* () {
...
function dockerBuild(imageName, build, cacheFrom, logResource, target) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield runCommandThatMustSucceed("docker", buildArgs, logResource);
    });
}
...
function getCommandLineMessage(cmd, args, reportFullCommandLine) {
    const argString = reportFullCommandLine ? args.join(" ") : args[0];
    return `'${cmd} ${argString}'`;
}
function getFailureMessage(cmd, args, reportFullCommandLine, code) {
...
function runCommandThatMustSucceed(cmd, args, logResource, reportFullCommandLine = true, stdin) {
    return __awaiter(this, void 0, void 0, function* () {
        const { code, stdout } = yield runCommandThatCanFail(cmd, args, logResource, reportFullCommandLine, /*reportErrorAsWarning:*/ false, stdin);
        if (code !== 0) {
...
function runCommandThatCanFail(cmd, args, logResource, reportFullCommandLine, reportErrorAsWarning, stdin) {
    return __awaiter(this, void 0, void 0, function* () {
